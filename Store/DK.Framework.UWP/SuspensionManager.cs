...
namespace DK.Framework.UWP
{
    ...
    /// upgraded.
    /// </summary>
    /// <remarks>Based on the out-of-the-box suspension manager in universal apps.</remarks>
    [Export(typeof(SuspensionManager))]
    [Shared]
    public sealed class SuspensionManager
    {
        const string NavigationStateKey = "Navigation";
        
        private static Dictionary<string, object> _sessionState = new Dictionary<string, object>();
        private static string SessionStateFilename = "_sessionState.xml";
        ...
        public static async Task SaveAsync()
        {
            try
            {
                ...
                await ApplicationState.SaveSerializedDataToFile(_sessionState, typeof(Dictionary<string, object>), SessionStateFilename);
            }
            catch (Exception e)
            {
        ...
        public static async Task RestoreAsync(String sessionBaseKey = null)
        {
            ...
            try
            {
                _sessionState = (Dictionary<string, object>)await ApplicationState.RestoreSerializedDataFromFile(SessionStateFilename);
        ...
        private static void RestoreFrameNavigationState(Frame frame)
        {
            ...
            if (frameState.ContainsKey(NavigationStateKey))
            {
                frame.SetNavigationState((String)frameState[NavigationStateKey]);
            }
        }
        ...
        {
            var frameState = SessionStateForFrame(frame);
            frameState[NavigationStateKey] = frame.GetNavigationState();
        }
    }
}
